...
<div class="body-box" style="float:right">
	<form id="jvForm" action="frupdate.do?id=${frs.id }" method="post" onsubmit="return chkAll()">
			...
			<tbody>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="title" id="title" onblur="chkTitle()" maxlength="100" value="${frs.title }"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="content" maxlength="100" value="${frs.content }"/>
					</td>
				</tr>			
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						公告时间:</td><td width="80%" class="pn-fcontent">
						<input type="text" class="Wdate" onclick="WdatePicker()" name="ctime" maxlength="80" value="${frs.ctime }"/>
					</td>
				</tr>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="cman" id="cman" onblur="chkCman()" maxlength="80" value="${frs.cman }"/>
